            ...
            <div class="col-md-12">
                ...
                <div class="form-row">
                    ...
                    <div class="col">
                        ...
                        <input type="Password" wire:model.defer="Password" class="form-control" placeholder="{{ trans('Parent_trans.Password') }}">
                        @error('Password')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
                <!--اسم الاب بالعربي والانجليزي-->
                <div class="form-row">
                    <div class="col">
                ...
                <button class="btn btn-danger btn-sm btn-lg pull-right" wire:click.prevent="showtable" type="button">
