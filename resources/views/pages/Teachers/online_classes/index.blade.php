            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('ZoomOnline.create')}}" class="btn btn-success" role="button" aria-pressed="true">  {{ trans('Students_trans.add_online_courses') }} </a>
                                <a href="{{route('offlineClasse.add')}}" class="btn btn-warning" role="button" aria-pressed="true">  {{ trans('Students_trans.online_courses_indirect') }} </a>
