 ...
 Main content -->
        ...
        <div class="content-wrapper">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="mb-0"> {{ trans('Teacher_trans.teacher_dashboard') }} {{auth()->user()->Name}}</h4>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                ...
                                href="{{route('studentDash.index')}}" target="_blank"><span class="text-danger"> {{trans('Students_trans.views')}}</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{trans('Teacher_trans.section_count')}}</p>
