...
@section('title')
    {{trans('accounts_trans.edit_invoice')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                    ...
                    <form action="{{route('FeeInvoice.update','test')}}" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputEmail4"> {{trans('accounts_trans.name_student')}}</label>
                        ...
                        <div class="form-group">
                            <label for="inputAddress">{{trans('accounts_trans.desc')}}</label>
                            <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="4">{{$fee_invoices->notes}}</textarea>
                        </div>
                        <br>
