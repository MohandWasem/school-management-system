...
@section('css')
    @toastr_css
@section('title')
{{trans('accounts_trans.edit_receipt')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{-- {{trans('accounts_trans.edit_receipt')}} : <label style="color: red">{{$receipt_student->student->Name}}</label> --}}
@stop
<!-- breadcrumb -->
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">  {{trans('accounts_trans.edit_receipt')}}  : <label style="color: red"> {{$receipt_student->student->Name}}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">{{ trans('Grades_trans.home') }}</a></li>
                <li class="breadcrumb-item active"> {{trans('accounts_trans.edit_receipt')}} {{$receipt_student->student->Name}}</li>
            </ol>
        </div>
    </div>
</div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input  class="form-control" name="Debit" value="{{$receipt_student->Debait}}" type="number" >
