...
@section('css')
    @toastr_css
@section('title')
{{trans('Students_trans.add_book_new')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">  {{trans('Students_trans.add_book_new')}}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">{{ trans('Sections_trans.Home') }}</a></li>
                <li class="breadcrumb-item active"> {{trans('Students_trans.add_book_new')}}</li>
            </ol>
        </div>
    </div>
</div>
