                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{route('Quizzes.store')}}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="Grade_id"> {{trans('Students_trans.name_teacher')}} : <span class="text-danger">*</span></label>
                                            <select class="custom-select mr-sm-2" name="teacher_id" required>
                                                <option selected disabled>{{trans('Students_trans.choose_teacher')}}</option>
