            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown mr-30">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{route('setting.update')}}"><i class="text-info ti-settings"></i>Settings</a>
                        ...
                        @endif
                        @csrf
                                <a class="dropdown-item" href="#" onclick="event.preventDefault();this.closest('form').submit();"><i class="bx bx-log-out"></i>{{trans('messages.logout')}}</a>
                            </form>                     
